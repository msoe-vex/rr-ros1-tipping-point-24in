...
BasicAuton::BasicAuton(IDriveNode* drive_node, OdometryNode* odom_node, ADIEncoderNode* y_odom_encoder, InertialSensorNode* inertial_sensor) : 
...
void BasicAuton::AddNodes() {
    AutonNode* forward_node = new AutonNode(10, new DriveStraightAction(m_drive_node, m_odom_node, 60, 50, 10));
